...
<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:70%"><!-- wp:image {"aspectRatio":"1/1","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":["#000000","#fd5370"]}},"className":"is-style-blue-note-rhomboid"} -->
<figure class="wp-block-image size-full is-style-blue-note-rhomboid"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Duke_Ellington.jpg" alt="" style="aspect-ratio:1/1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
