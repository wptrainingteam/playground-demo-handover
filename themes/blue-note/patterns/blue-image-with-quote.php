...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Louis_Armstrong.jpg" alt="" class="has-border-color" style="border-color:#4b99f8;border-width:2px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
