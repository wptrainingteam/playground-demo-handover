...
<figure class="wp-block-image size-full is-resized is-style-blue-note-thick-stripes"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Cab_Calloway_Gottlieb.jpg" alt="" style="aspect-ratio:16/9;object-fit:cover;width:847px" width="847"/></figure>
<!-- /wp:image -->
